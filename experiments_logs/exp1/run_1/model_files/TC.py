...
class TC(nn.Module):
    def __init__(self, configs, device):
        ...
        self.linear = nn.Linear(configs.TC.hidden_dim, configs.num_classes)
        self.shift_cls_layer = nn.Linear(configs.TC.hidden_dim, 2)
    ...
    def forward(self, features_aug1, features_aug2):
        ...
        return nce, self.projection_head(c_t), self.shift_cls_layer(c_t)