...
if training_mode == 'T':
    store_path = 'result_files/final_ood_'+ data_type +'_T_'+str(neg_ths)+'-novel.xlsx'
    store_path_2 = 'result_files/Summary_ood_'+ data_type +'_T_'+str(neg_ths)+'-novel.xlsx'
elif training_mode == 'F':
    store_path = 'result_files/final_ood_'+ data_type +'_F_'+str(neg_ths)+'-novel.xlsx'
    store_path_2 = 'result_files/Summary_ood_'+ data_type +'_F_'+str(neg_ths)+'-novel.xlsx'
else:
    raise ValueError
...
if training_mode == 'T':
    with open('./data/'+data_type+'_s_'+str(neg_ths)+'-novel.data', 'wb') as f:
        pickle.dump(strong_set, f)

    with open('./data/'+data_type+'_w_'+str(neg_ths)+'-novel.data', 'wb') as f:
        pickle.dump(weak_set, f)

    with open('./data/'+data_type+'_multi_'+str(neg_ths)+'-novel.data', 'wb') as f:
        pickle.dump(final_multiST, f)
    
elif training_mode == 'F':
    with open('./data/'+data_type+'_fs_'+str(neg_ths)+'-novel.data', 'wb') as f:
        pickle.dump(strong_set, f)
    
    with open('./data/'+data_type+'_fw_'+str(neg_ths)+'-novel.data', 'wb') as f:
        pickle.dump(weak_set, f)

    with open('./data/'+data_type+'_multi_f_'+str(neg_ths)+'-novel.data', 'wb') as f:
        pickle.dump(final_multiST, f)
